document.addEventListener('DOMContentLoaded', function() {
        ...
        .then(data => {
            ...
            data.forEach(markerInfo => {
                ...
                marker.bindPopup(`
                    ...
                    <button onclick="showRoute(${markerInfo.lat}, ${markerInfo.lng}, '${markerInfo.title}', '${markerInfo.alamat}')">Kunjungi</button>
                `);
    ...
    window.showRoute = function(destinationLat, destinationLng, title, alamat) {
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(function(position) {
                ...
                // Tampilkan detail fasilitas kesehatan yang dikunjungi
                document.getElementById('detail').innerHTML = `
                    <div class="container">
                        <h2>Detail Fasilitas Kesehatan</h2>
                        <h3>${title}</h3>
                        <p>Alamat: ${alamat}</p>
